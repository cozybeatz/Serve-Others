...
import { FaShieldAlt, FaArrowDown, FaWindowClose } from "react-icons/fa";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-stone-50 relative">
      ...
      {/* POPUP FORM */}
      <div className="z-20 absolute top-20 py-10 px-5 mx-5 bg-stone-900 rounded-md md:w-3/5 lg:w-2/5">
        <div className="mx-auto">
          <div className="text-right">
            <HiOutlineX className="text-white" onClick={} />
          </div>
          <p className="text-stone-50 text-lg text-center font-semibold">
            Reserve Your FREE 2-Week VIP Trial
          </p>
          <p className="relative z-10 text-stone-200 mt-10 text-lg text-center">
            This is basically <span className="text-amber-600 "></span> free
            access to a{" "}
            <span className="text-amber-600 ">$30k per year Mastermind</span>.{" "}
            <br />
            (It
            {"'"}s only <span className="text-amber-600 ">$97/mo</span> after -
          ...
          <form className="relative my-4 z-10">
            ...
            <div className="relative w-max mx-auto hover:-translate-y-1 transition-all">
              <button
                className={
                  "z-10 relative rounded-md bg-amber-600 text-black px-16 py-4 font-bold text-xl" +
                  " " +
                  grotesque.className
                }
              >
